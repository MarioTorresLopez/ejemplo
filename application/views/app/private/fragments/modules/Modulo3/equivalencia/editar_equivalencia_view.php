...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="hpanel hblue">
            ...
            <!--panel body START-->
            <form role="form" id="form" action="<?= base_url() ?>analista_servicios/equivalencia/editar_solicitud_post"  method="post">
            <div class="panel-body">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="ap_eq" class="form-control" name="ap_eq" value="<?=$solicitud->ap1?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="am_eq" class="form-control" name="am_eq" value="<?=$solicitud->ap2?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="nom_eq" class="form-control" name="nom_eq" value="<?=$solicitud->nombre?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <label>CURP</label>
                                <input type="text" id="curp_eq" class="form-control" name="curp_eq" value="<?=$solicitud->curp?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        <!--</div>-->
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <div class="col-sm-4">
                                <label>Colonia</label>
                                <input type="text" id="colonia_eq" class="form-control" name="colonia_eq" value="<?=$solicitud->colonia?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="cp_eq" class="form-control" name="cp_eq" value="<?=$solicitud->cp?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="tel_eq" class="form-control" name="tel_eq" value="<?=$solicitud->telefono?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="correo_eq" class="form-control" name="correo_eq" value="<?=$solicitud->correo?>">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        <!--</div>-->
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" style="width: 100%" name="nivel_procedencia" id="nivel_procedencia">
                                    ...
                                    if($solicitud->nivelcursado=='BACHILLERATO O PREPARATORIA'){
                                    ?>
                                    <option value="BACHILLERATO GENERAL">Bachillerato General</option>
                                    <option value="BACHILLERATO O PREPARATORIA" selected="selected">Bachillerato ó Preparatoria</option>
                                    <option value="BACHILLERATO TECNOLÓGICO">Bachillerato Tecnológico</option>
                                    <option value="PREPARATORIA ABIERTA">Preparatoria Abierta</option>
                                    <option value="TÉCNICO POSTSECUNDARIO">Técnico Postsecundario</option>
                                    <option value="TÉCNICO SUPERIOR UNIVERSITARIO">Técnico Superior Universitario</option>
                                    ...
                                    if($solicitud->nivelcursado=='PREPARATORIA ABIERTA'){
                                    ?>
                                    <option value="BACHILLERATO GENERAL">Bachillerato General</option>
                                    <option value="BACHILLERATO O PREPARATORIA">Bachillerato ó Preparatoria</option>
                                    <option value="BACHILLERATO TECNOLÓGICO">Bachillerato Tecnológico</option>
                                    <option value="PREPARATORIA ABIERTA" selected="selected">Preparatoria Abierta</option>
                                    <option value="TÉCNICO POSTSECUNDARIO">Técnico Postsecundario</option>
                                    <option value="TÉCNICO SUPERIOR UNIVERSITARIO">Técnico Superior Universitario</option>
                                    <option value="LICENCIATURA">Licenciatura</option>
                                    <option value="ESPECIALIDAD">Especialidad</option>
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        <div class="form-group">
                            <div class="col-sm-8">
                                ...
                                <input type="text" id="inst_proc" class="form-control" name="inst_proc" value="<?=$solicitud->instituciondeprocedencia?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php
                                if($solicitud->especifiaciondestino!=NULL){
                                ?>
                                <label>En:</label>
                                <input type="text" id="especificacion_nuevo" class="form-control" name="especificacion_nuevo" value="<?=$solicitud->especifiaciondestino?>" style="text-transform: uppercase;">
                                <?php
                                }else{
                    ...
                    <div class="col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            <div class="col-sm-8">
                                <label>Ciudad y Estado donde se localiza la institución</label>
                                <input type="text" id="ciu_est_inst_nuevo" class="form-control" name="ciu_est_inst_nuevo" value="<?=$solicitud->ciudadestadoinstdestino?>" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                        </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="act_nac" id="act_nac">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->actanaciemiento==0){
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" style="width: 100%" name="certf_sec" id="certf_sec">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadosecundaria==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" style="width: 100%" name="certf_post" id="certf_post">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadotecpostsecundario==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="certf_bach" id="certf_bach">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadobachillerato  ==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="certf_tsu" id="certf_tsu">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadotecsupuni==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="certf_lic" id="certf_lic">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadolicenciatura==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="certf_esp" id="certf_esp">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadoespecialidad==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="certf_mst" id="certf_mst">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->certificadomaestria==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" style="width: 100%" name="carta_acep" id="carta_acep">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->cartaceptacionedunormal==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" style="width: 100%" name="carta_ren" id="carta_ren">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->cartarenunciasemestreasig==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control" style="width: 100%" name="comprobante" id="comprobante">
                                    <option value="---Seleccione---">---Seleccione---</option>
                                    <?php
                                    if($solicitud->comprobantepagosderecho==0){
                                    ?>
                                    <option value="1">SI</option>
                                    <option value="0" selected="selected">NO</option>
                                    <?php
                ...
                <div class="text-right m-t-xs">
                    ...
                    <input type="hidden" value="<?=$solicitud->idsolicitudequivalencia?>" id="solicitud" name="solicitud">
                    <a class="btn btn-primary"  id="validacion_registro_solicitud" name="validacion_registro_solicitud">Editar solicitud</a>
                    <a href="<?= base_url()?>analista_servicios/equivalencia/solicitudes" class="btn btn-danger">Cancelar</a>
                </div>
