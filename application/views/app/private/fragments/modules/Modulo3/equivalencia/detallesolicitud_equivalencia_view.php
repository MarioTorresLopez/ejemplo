                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        <div class="form-group">
                            <div class="col-sm-8">
                                ...
                                <input type="text" id="inst_proc" class="form-control" name="inst_proc" value="<?=$solicitud->instituciondeprocedencia?>" style="text-transform: uppercase;" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                ?>
                                <label>En:</label>
                                <input type="text" id="especificacion_nuevo" class="form-control" name="especificacion_nuevo" value="<?=$solicitud->especifiaciondestino?>" style="text-transform: uppercase;" disabled>
                                <?php
                                }else{
                    ...
                    <div class="col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            <div class="col-sm-8">
                                <label>Ciudad y Estado donde se localiza la institución</label>
                                <input type="text" id="ciu_est_inst_nuevo" class="form-control" name="ciu_est_inst_nuevo" value="<?=$solicitud->ciudadestadoinstdestino?>" style="text-transform: uppercase;" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
                            <div class="form-group">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <input type="text" id="certf_sec" class="form-control" name="certf_sec" value="<?=$certf_sec?>" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <input type="text" id="certf_post" class="form-control" name="certf_post" value="<?=$certf_post?>" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <input type="text" id="carta_acep" class="form-control" name="carta_acep" value="<?=$carta_acep?>" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <input type="text" id="carta_ren" class="form-control" name="carta_ren" value="<?=$carta_ren?>" disabled>
                                <span class="help-block"></span>
                            </div>
                        </div>
