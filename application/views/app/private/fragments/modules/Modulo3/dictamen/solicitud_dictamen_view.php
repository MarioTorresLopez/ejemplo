                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label>Fecha: </label>
                                    <input type="date" id="fecha_sol" class="form-control" name="fecha_sol"  value="<?php echo date('Y-m-d'); ?>" placeholder="*CAMPO REQUERIDO" style="text-transform: uppercase;" disabled>
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="ap_dic" class="form-control" name="ap_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="am_dic" class="form-control" name="am_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="nom_dic" class="form-control" name="nom_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <label>CURP</label>
                                <input type="text" id="curp_dic" class="form-control" name="curp_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        <!--</div>-->
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <div class="col-sm-4">
                                <label>Colonia</label>
                                <input type="text" id="colonia_dic" class="form-control" name="colonia_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="cp_dic" class="form-control" name="cp_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="tel_dic" class="form-control" name="tel_dic" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="correo_dic" class="form-control" name="correo_dic" placeholder="*Campo requerido">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        <!--</div>-->
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label>En:</label>
                                <input type="text" id="especificacion_nuevo" class="form-control" name="especificacion_nuevo" placeholder="*Campo requerido" style="text-transform: uppercase;">
                                <span class="help-block"></span>
                            </div>
                            </div>
                        <!--</div>-->
