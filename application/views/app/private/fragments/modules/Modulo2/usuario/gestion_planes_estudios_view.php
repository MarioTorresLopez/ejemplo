            ...
            <div class="panel-body">
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <!--form START-->
                        <form id="form" action="<?= base_url() ?>usuario/gestion_planes_estudios/agregar_plan_estudios" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label>Carrera</label>
                                    <select class="js-source-states" style="width: 100%" name="carrera" id="carrera">
                                        <option>---Seleccione---</option>
                                        <?php
                                        if (!is_null($carreras)) :
                                ...
                                if (!is_null($planes_estudios)) :
                                    foreach ($planes_estudios as $plan_estudios) :
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $plan_estudios->nomcarrera ?></td>
                                            <td><?= $plan_estudios->nomespecialidad ?></td>
                                            <td><?= $plan_estudios->nommodalidad ?></td>
                                            <td>
                                                <a href="<?= base_url() ?>usuario/gestion_mapa_curricular/mc_pe/<?= $plan_estudios->idpe ?>">
