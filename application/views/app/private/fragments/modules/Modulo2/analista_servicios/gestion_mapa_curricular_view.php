            ...
            <div class="panel-body">
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <!--form START-->
                        <form id="form" action="<?= base_url() ?>analista_servicios/gestion_mapa_curricular/crear_mapa_curricular" method="post">
                                ...
                                if (!is_null($mapas_curriculares)) :
                                    foreach ($mapas_curriculares as $mapa_curricular) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url() ?>analista_servicios/gestion_mapacurricular_materias/mc_materias/<?= $idinstitucion ?>/<?= $idpe ?>/<?= $mapa_curricular->idmc ?>">
