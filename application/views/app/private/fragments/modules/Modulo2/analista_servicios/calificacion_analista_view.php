        ...
        <div class="hpanel hblue">
            ...
            <div class="panel-body" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form id="form-multimedia-data" class="dropzone" action="<?= base_url() ?>dropzone/subir_excel_calificacion" enctype="multipart/form-data"> </form>
                        </div>
                                   <!-- col-lg-12 START -->
                        <div class="col-lg-12 " class="form-control" id="tablaexcel">
                            ...
                            <!-- col-lg-12 END -->
                                ...
                                <!-- col-lg-12 START -->
<!--                                <div class="col-lg-12" >
                                    <button class="btn btn-primary next aceptarCalificacion text-left" 
