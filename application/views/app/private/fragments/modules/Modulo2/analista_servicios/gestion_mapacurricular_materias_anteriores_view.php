            ...
            <div class="panel-body">
                ...
                <div class="row well well-lg">
                    ...
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        ...
                        <!--form START-->
                        <form id="" action="<?= base_url() ?>analista_servicios/gestion_mapacurricular_materias/crear_mapa_curricular_materias_anterior" method="post">
                ...
                <div class="text-right m-t-xs">
                    <a class="btn btn-primary validargrupo agregar"  id="">Agregar materia</a>
                ...
                <div class="row well well-lg">
                    ...
                    <!-- form-group col-lg-12 START -->
                    <div class="form-group col-lg-12" style="font-family: 'Soberana Sans'; font-size: 1.5rem;">
                        <form id="form" action="<?= base_url() ?>analista_servicios/gestion_mapacurricular_materias/crear_mapa_curricular_materias_anterior" method="post">
                            <input type="hidden" id="id_pe" class="form-control" name="id_pe" value="<?= $plan_estudios->idpe ?>">
                            <input type="hidden" id="id_mc" class="form-control" name="id_mc" value="<?= $mapa_curricular->idmc ?>">
                ...
                <!-- ROW END --> 
                <div class="text-right m-t-xs">
                    <a class="btn btn-primary validargrupo anadir"  id="">Añadir materias</a>
                    <!--<a class="btn btn-danger" id="btnvalidarcancelar">Cancelar</a>-->
                </div>
