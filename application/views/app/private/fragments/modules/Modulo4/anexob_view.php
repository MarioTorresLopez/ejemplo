    ...
    <div class="col-lg-12">
        ...
        <div class="hpanel hblue">
            ...
            <div class="panel-heading" style="font-family: 'Soberana Sans'; font-size: 2rem;">
                ...
                <!-- panel-tools END -->
                Subir plantilla de personal docente 
            </div>
            <!-- panel-heading END -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div id="body" class="form-group col-lg-12">		
                            <form id="form-multimedia-data" class="dropzone" action="<?= base_url() ?>analista_servicios/plantilla_docente/subir_excel" enctype="multipart/form-data"> </form>
                        </div>
                        <br>
                        <!-- col-lg-12 START -->
