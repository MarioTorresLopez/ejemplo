                ...
                ?>
                    <form role="form" id="form" action="<?= base_url()?>administrador/tipo_ingreso/editar_post" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre_ingreso_adminstrador" name="nombre_ingreso_adminstrador"  value="<?=$tipo_ingreso->nomingreso?>" placeholder="*Campo requerido" class="form-control" style="text-transform: uppercase;" required>
