...
class grupo extends CI_Controller{
    ...
    public function index(){
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Listado de grupos";
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\administrador\grupo_admin_view', $data, TRUE);
