...
/**
 * Description of mensaje_analista_calificacion
 *
 * @author UTEQ
 */
class mensaje_calificacion extends CI_Controller {
    ...
    public function index() {
        ...
        */
         ...
         */
                ...
                $data['scripts'][] = 'aceptarCalificacionAdministrador';
         ...
         */
        $data['breadcrumbs']['titulo'] = "Enviar mensaje al usuario";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/mensaje_admin_calificacion_view', $data, TRUE);
