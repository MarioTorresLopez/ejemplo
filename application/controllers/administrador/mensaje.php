...
/**
 * Description of mensaje_analista
 *
 * @author UTEQ
 */
class mensaje extends CI_Controller {
    ...
    public function index() {
        ...
        */
         ...
         */
                $data['scripts'] = array();
                $data['scripts'][] = 'scriptEliminarInscripcion';
                $data['scripts'][] = 'aceptarInscripcionAdministrador';
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/mensaje_admin_view', $data, TRUE);
