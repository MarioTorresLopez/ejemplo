...
class calificaciones extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['scripts'] = array();
        $data['scripts'][] = 'mensajeAdministradorCalificacion';
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/calificaciones_admin_view', $data, TRUE);
