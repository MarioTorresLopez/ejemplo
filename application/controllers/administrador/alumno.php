...
class alumno extends CI_Controller{
    ...
    public function index(){
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Listado de alumnos";
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\administrador\alumno_admin_view', $data, TRUE);
