 ...
 * @author CIDTAI-UTEQ
 */
class bitacora_admi  extends CI_Controller{
    //put your code here
    ...
    public function index (){
      ...
      /** 		  
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Bitácora";
        ...
        */
        ...
        $data['registrosBitacora'] = $this->bitacora_model->consultar_bitacoras_all();
        if ($a != 2 && $a != 3) {
      ...
      //  $data['bitacoras'] = $this->bitacora_model->consultar_bitacora();
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/administrador/bitacora', $data, TRUE);
