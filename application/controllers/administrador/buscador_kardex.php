 ...
 */
class buscador_kardex extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         * titulo de la pagina
         */
        $data['titulo'] = app_title() . " | Buscador de kardex";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Buscador de kardex";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/buscador_kardex_view', $data, TRUE);
