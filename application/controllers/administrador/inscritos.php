...
/**
 * Description of inscritos_analista
 *
 * @author UTEQ
 */
class inscritos extends CI_Controller {
    ...
    public function index() {
        ...
        */
         ...
         */
        $data['scripts'] = array();
           $data['scripts'][] = 'mensajeAdministrador';
        /**
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/inscrito_admin_view', $data, TRUE);
