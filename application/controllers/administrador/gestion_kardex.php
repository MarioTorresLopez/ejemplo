...
class gestion_kardex extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         * titulo de la pagina
         */
        $data['titulo'] = app_title() . " | Gestión de trámite de kardex";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Gestión de trámite de kardex";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/administrador/gestion_kardex_view', $data, TRUE);
