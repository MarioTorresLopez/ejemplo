<?php
/**
 * Controlador para la vista de gestion escolar para el administrador
 *
 * Clase que visualiza las instituciones, planteles, carreras
 * si esta cuenta moistrara las especialidades y las opciones 
 * para gestionar
 * 
 * @since 1.0
 * @version 1.0
 ...
 */
class gestion_escolar extends CI_Controller{
    ...
    public function index() {
        ...
        */
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Gestión escolar";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Gestión escolar";
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\administrador\gestion_escolar_admin_view', $data, TRUE);
