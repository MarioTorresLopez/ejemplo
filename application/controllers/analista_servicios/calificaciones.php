...
/**
 * Description of calificaciones_analista
 *
 * @author UTEQ
 */
class calificaciones extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['scripts'] = array();
        $data['scripts'][] = 'mensajeAnalistaCalificacion';
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Calificaciones";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/calificaciones_analista_view', $data, TRUE);
