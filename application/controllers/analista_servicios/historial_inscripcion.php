...
/**
 * Controlador para la vista de historial de inscripcion
 *
 * Clase que visualiza las todos los alumnos inscritos
 * y ver sus calicaciones
 * 
 * @since 1.0
 * @version 1.0
 * @link   /
 ...
 */
class historial_inscripcion extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Historial Inscripción";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Historial inscripciones";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\historial_inscripcion_analista_view', $data, TRUE);
