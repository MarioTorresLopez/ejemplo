<?php
/**
 * Controlador del detalle de kardex para
 * escuelas normales
 *
 * Mostrara la vista de kardex para escuelas normales
 * 
 * @since      1.0
 * @version    1.0
 * @link       /app/detalle_kardex_superio_normal
 ...
 */
class detalle_kardex_normal extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Gestión de tramite de Kardex";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/detalle_kardex_superio_normal_view', $data, TRUE);
