 ...
 */
class reporte_inicio_general extends CI_Controller{
    ...
    public function  index() {
        ...
        */
        ...
        $data['scripts'][] = 'reporte_inicio_general';
        $data['scripts'][] = 'grafica_reporte_inicio';
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/reporte_inicio_general_view', $data, TRUE);
...
//             
        ...
        if($instituciones !=null){
            ...
            foreach ($instituciones as $ins) {
                 $suma[$ins->idinstitucion] = $this->reporte_inicio_model->consultar_suma($ins->idinstitucion);
        ...
        echo $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/reporte_inicio_general_view_dos', $data, TRUE);
