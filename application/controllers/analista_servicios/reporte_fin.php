 ...
 */
class reporte_fin extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/reporte_fin_view', $data, TRUE);
