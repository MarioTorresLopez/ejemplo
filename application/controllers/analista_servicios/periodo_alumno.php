...
/**
 * Description of periodo_analista
 *
 * @author UTEQ
 */
class periodo_alumno extends CI_Controller{
    ...
    public function mostrar_periodos_alumno_analista($idinstitucion, $idnivel, $idalumno){
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Periodo de alumno";
        ...
        */
        ...
        $data['thead_periodos'] = $this->filtrados_escolar_model->consultar_thead_periodos_alumno($idinstitucion, $idnivel,$idalumno);
        $data['listado_periodos_alumno'] = $this->filtrados_escolar_model->consultar_listado_periodos_alumno($idinstitucion, $idnivel, $idalumno);
        ...
        $data['scripts'] = array();
        $data['scripts'][] = 'eliminar_periodo_analista';
         ...
         */
        $data['breadcrumbs']['titulo'] = "Lista de periodos";
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), array('Gestión de alumnos', base_url() .'analista_servicios/gestion_alumnos'), 'Lista de periodos');
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\periodo_alumno_analista_view', $data, TRUE);
