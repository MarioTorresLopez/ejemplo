...
/**
 * Controlador para la vista de detalle de calificacion del alumno
 *
 * Clase que visualiza las calificaciones del alumno
 * 
 * @since 1.0
 * @version 1.0
 * @link   /
 ...
 */
class detalle_calificacion extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Detalle Calificación";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Detalle calificación";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\detalle_calificacion_analista_view', $data, TRUE);
