...
class grupo extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array();
        $data['scripts'] =array();
        $data['scripts'][]='lista_alumnos';
        $data['titulo'] = app_title() . " | Grupo";
        
        $data['scripts'] = array();
        $data['scripts'][] = 'eliminar_grupo_analistaS';
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Lista de grupo";
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\grupo_analista_view', $data, TRUE);
    ...
    public function editar(){
        ...
        */
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Editar grupo";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\grupo_editar_view', $data, TRUE);
