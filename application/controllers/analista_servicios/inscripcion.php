...
class inscripcion extends CI_Controller {
    ...
    public function index() {
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/inscripcion_analista_view', $data, TRUE);
...
//        $fila=$excel[$contnoinscritos][12];
//        $especialidad_noi=$excel[$contnoinscritos][0];
//        
//        $noinscritos[$contnoinscritos][0]=$fila;
//        $noinscritos[$contnoinscritos][1]=$especialidad_noi;
