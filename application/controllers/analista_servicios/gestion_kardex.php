<?php
/**
 * Controlador de gestion de kardex
 *
 * Mostrara la vista de gestion de kardex donde
 * se visualizaran los ultimos generados y adicional
 * una busqueda para tramitir un nuevo kardex por 
 * medio de una busqueda
 * 
 * @since      1.0
 * @version    1.0
 * @link       /app/gestion_kardex
 ...
 */
class gestion_kardex extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         * titulo de la pagina
         */
        $data['titulo'] = app_title() . " | Lista de kardex";
        ...
        */
         ...
         */
        $data['breadcrumbs']['titulo'] = "Lista de kardex";
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), 'Lista de kardex');
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/analista_servicios/gestion_kardex_view', $data, TRUE);
