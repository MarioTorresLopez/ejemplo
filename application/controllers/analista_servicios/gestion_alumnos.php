...
class gestion_alumnos extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['listado_alumnos_analista'] = $this->filtrados_escolar_model->consultar_listado_alumnos_analista();
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\gestion_alumnos_analista_view', $data, TRUE);
