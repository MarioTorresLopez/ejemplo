...
/**
 * Controlador para la vista de detalle de inscripcion
 *
 * Clase que visualiza la informacion de un alumno seleccionado
 * 
 * @since 1.0
 * @version 1.0
 * @link   /
 ...
 */
class detalle_inscripcion extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Detalle Inscripción";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Detalle inscripciones";
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\analista_servicios\detalle_inscripcion_analista_view', $data, TRUE);
