 ...
 * 
 */
class solicitudes_de_cuentas extends CI_Controller{
    ...
    /**
     * Función para las solicitudes aceptadas
     * 
     * Incluye la vista para visualizar los datos del usuario que ya han sido aceptados para
     * dar seguimiento del proceso para un nuevo acuerdo.
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link app/public/usuario/solicitudes_cuentas_view
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    ...
    public function index() {
        ...
        $data['solicitudes'] = $this->solicitud_model->consultar_solicitudes_aceptadas();
        
        /*
         * parametro  que se manda a la vista para visualizar el 
         * titulo de la pagina
         */
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), 'Solicitudes aceptados');
        ...
        */
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/analista/solicitudes_cuentas_view', $data, TRUE);
