...
/**
 * Description of detalle_datos_cuenta_solicitud
 *
 * @author UTEQ
 * 
 ...
 */
class detalle_datos_cuenta_solicitud extends CI_Controller{
    //put your code here
    /**
    ...
    public function usuario_aceptado($idsoli) {
        /** 		  
        ...
        $data['solicitud'] = $this->solicitud_model->consultar_solicitud_aceptada($idsoli);
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), array('Solicitudes aceptados', base_url().'analista/solicitudes_de_cuentas'), 'Detalle de datos');
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/analista/detalle_datos_cuenta_solicitud_view', $data, TRUE);
