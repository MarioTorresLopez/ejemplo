...
/**
 * Controlador del modulo de registro de calificaciones
 *
 * Clase que muestra las funciones de registro de calificaciones junto con la 
 * GUI correspondiente al nivel de usuario
 * 
 * @since      1.0
 * @version    1.0
 * @link       /app/alta_calificaciones
...
class calificaciones extends CI_Controller {
	 ...
	 * 
	 * Incluye la vista para la seccion de registro de calificaciones
	 * 
	 * @since 1.0
	 * 
	 * @version 1.0
	 * @link /app/calificaciones/alta_calificaciones
	 * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
	 * @return View
	 */
	...
	public function index(){
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Calificaciones";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Registro de calificaciones";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/calificaciones_view', $data, TRUE);
