...
/**
 * Controlador para la vista de periodos escolar, carreras, especializacion y grupos
 *
 * Clase que visualiza los periodos que se tienen registrados en el sistema
 * dependiendo al mapa curricular
 * 
 * @since 1.0
 * @version 1.0
 * @link   /
...
class periodos_mss extends CI_Controller{
     ...
     * 
     * Incluye la vista para visualizar la tabla de los los periodos
     * escolares registrados en el sistema 
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /control_escolar/periodos_mss/planteles
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    
    public function periodos_ciclo_escolar() {
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Periodo Escolar";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Periodos Escolar";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/periodos_mss_view', $data, TRUE);
    ...
    /**
     * Función para la vista de carreras_view
     * 
     * Incluye la vista para visualizar la tabla de las 
     * carreras registradas en el sistema
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /control_escolar/periodos_mss/carreras
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    ...
    public function carreras() {
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Carreras";
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Carreras";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/carreras_view', $data, TRUE);
    ...
    /**
     * Función para la vista de grupos_view
     * 
     * Incluye la vista para visualizar la tabla de los 
     * grupos que estan dados de alta en la carrera seleccionada
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /control_escolar/periodos_mss/grupos
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    ...
    public function grupos() {
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Grupos";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/grupos_view', $data, TRUE);
