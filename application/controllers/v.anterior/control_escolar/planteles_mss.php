...
/**
 * Controlador para la vista de planteles 
 *
 * Clase que visualiza los planteles que se tienen registrados 
 * por parte de dicha institucion 
 * 
 * @since 1.0
 * @version 1.0
 * @link   /
...
class planteles_mss extends CI_Controller{
     ...
     * 
     * Incluye la vista para visualizar la tabla de los registros de planteles
     * que se tienen hasta el momento de dicha institución
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /control_escolar/planteles_mss/planteles
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    ...
    public function planteles() {
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Planteles Media Superior y Superior";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Planteles Media Superior";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/planteles_institucion_view', $data, TRUE);
