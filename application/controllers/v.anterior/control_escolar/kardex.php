...
/**
 * Controlador del modulo de generacion de kardex
 *
 * Clase que muestra las funciones del modulo de kardex junto con la 
...
class kardex extends CI_Controller {
	 ...
	 * 
	 * Incluye la vista para la seccion de generacion de kardex
	 * 
	 * @since 1.0
	 * 
	 * @version 1.0
	 * @link /app/kardex/nuevo
	 * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
	 * @return View
	 */
	...
	public function index(){
         ...
         */
        $data['breadcrumbs']['titulo'] = "Generacion de kardex";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/kardex_view', $data, TRUE);
