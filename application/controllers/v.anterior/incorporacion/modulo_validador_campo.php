...
/**
 * Description of modulo_validador_campo
 *
 * @author UTEQ
 */
class modulo_validador_campo extends CI_Controller {
    ...
    public function gestionn() {
        ...
        $data['area_de_trabajo'] = $this->load->view('area_de_trabajo/Validador_campo/modulo_validar_campo_view', $data, TRUE);
    ...
    public function gestion() {
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Validador";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Validador Campo";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Validador_campo/modulo_validar_campo_view', $data, TRUE);
