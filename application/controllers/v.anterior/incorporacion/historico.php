<?php
/**
 * Controlador para mostrar la seccion de hostoriales
 * 
 * Clase que carga los modelos y las vistas que pertenecen a la seccion de historiales
 * 
 *@since 1.0
 *@version 1.0
 *@link /incorporacion/historico
 *@global   constant String BASEPATH Indica la ruta de la carpeta system de este proyecto
 *@subpackage incorporacion
...
class historico extends CI_Controller {
	 ...
	 * 
	 * Incluye la vista para la seccion de consulta de historiales
	 * 
	 * @since 1.0
	 * 
	 * @version 1.0
	 * @link /historico/historiales
	 * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
	 * @return View
	 */
         ...
         */
        $data = array();
        $data['titulo'] = app_title() . " | Historico";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Historiales";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Historiales/historiales_view', $data, TRUE);
    ...
    /**
     * Función secundaria para consulta de detalle
     * 
     * Incluye la vista la consulta del detalle del historial de propietarios
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /historico/detalle_prop
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    public function detalle_prop() {
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Detalle de propietario";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Historiales/detalle_prop_view', $data, TRUE);
     ...
     * Función secundaria para consulta de detalle
     * 
     * Incluye la vista la consulta del detalle del historial de instituciones
     * 
     * @since 1.0
     * 
     * @version 1.0
     * @link /historico/detalle_inst
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    public function detalle_inst() {
        $correousu = $this->input->post('username');
        $passwordusu = md5($this->input->post('password'));
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Detalle de institucion";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Historiales/detalle_inst_view', $data, TRUE);
     ...
     * Función secundaria para consulta de detalle
     * 
     * Incluye la vista la consulta del detalle del historial de planteles
     * 
     * @since 1.0
     * 
     * @version 1.0
     ...
     * @return View
     */
    public function detalle_plantel() {
        $correousu = $this->input->post('username');
        $passwordusu = md5($this->input->post('password'));
         ...
         * Indica el titulo de la sección dentro del panel superior
         */
        $data['breadcrumbs']['titulo'] = "Detalle de plantel";
        $data['breadcrumbs']['subtitulo'] = "Subtitulo";
         ...
         * Referencia al fragmento del contenido de esta sección
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Historiales/detalle_plantel_view', $data, TRUE);
