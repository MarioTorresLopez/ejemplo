...
/**
 * Description of consentrado_de_documetos_validador_campo
 *
 * @author UTEQ
 */
class consentrado_de_documetos_validador_campo extends CI_Controller {

    //put your code here
    public function revisare() {
        $data = array();
        ...
        $data['area_de_trabajo'] = $this->load->view('area_de_trabajo/Validador_campo/consentrado_de_documentos_view', $data, TRUE);
    ...
    public function revisar() {
        ...
        $data = array();
        $data['titulo'] = app_title() . " | Concentrado documentos";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Concentrado";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/Validador_campo/consentrado_de_documentos_view', $data, TRUE);
