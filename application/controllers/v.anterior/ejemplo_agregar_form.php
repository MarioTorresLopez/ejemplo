...
class Ejemplo_agregar_form extends CI_Controller {
    ...
    public function index()
    {
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/efd_fragment', $data, TRUE);
...
/* End of file ejemplo_agregar_form.php */
/* Location: ./application/controllers/ejemplo_agregar_form.php */
