...
class notificacion extends CI_Controller {
    ...
    public function index() {
        ...
        ///$data['modulos'] = array();
        $data['titulo'] = app_title() . " | Notificaciones";
         ...
         */
        $data['breadcrumbs']['titulo'] = "Notificaciones";
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url() . 'app/inicio'), array('Notificaciones', '#'));
...
//                }
        ...
        if($a!=2 && $a!=3){
            $data['notificacioness'] =  $this->notificacion_model->get_notificaciones_all($a);
        }
        else{
           $data['notificacioness'] =  $this->notificacion_model->get_notificaciones_all($a,$id); 
        }
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/notificaciones_view', $data, TRUE);
