...
class detalle_kardex extends CI_Controller{
    ...
    public function  index() {
        ...
        */
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), array('Gestión de alumnos', base_url() .'usuario/gestion_alumnos'), array('Lista de períodos', base_url() .'usuario/periodo_alumno'), 'Trámite de kardex');
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/usuario/detalle_kardex_view', $data, TRUE);
