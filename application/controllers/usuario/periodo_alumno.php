...
class periodo_alumno extends CI_Controller{
    ...
    public function mostrar_periodos_alumno($idinstitucion, $idnivel, $idalumno){
        ...
        */
        ...
        $data['thead'] = $this->filtrados_escolar_model->consultar_thead_periodos_alumno($idinstitucion, $idnivel, $idalumno);
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), array('Gestión de alumnos', base_url() .'usuario/gestion_alumnos'), 'Lista de periodos');
         ...
         */
        $data['app_fragment'] = $this->load->view('app\private\fragments\modules\Modulo2\usuario\periodo_alumno_view', $data, TRUE);
