...
class calificacion_subir extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['scripts'][] = 'aceptarCalificacion';
         ...
         */
        $data['breadcrumbs']['titulo'] = "Subir Calificacion";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/usuario/calificacion_usuario_view', $data, TRUE);
