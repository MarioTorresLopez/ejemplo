...
/**
 * Controlador para vizualizar los documentos 
 *
...
class historial_documento extends CI_Controller {
     ...
     * 
     * @version 1.0
     * @link app/historial_documento/mostrar_historial
     * @author CIDTAI - UTEQ Dev Team <cidtai@uteq.edu.mx>
     * @return View
     */
    public function mostrar_historial($idacu, $idusu) {
        ...
        $data['scripts'] = array();
        $data['scripts'][] = 'mostrarDocumentoHistorial';
        $data['titulo'] = app_title() . " | Historial de Documentos";
        ...
        $data['documentos'] = $this->documento_model->consultar_documentos_acuerdo($idacu, $idusu);
         ...
         */
        $data['breadcrumbs']['links'] = array(array('AIDE', '#'), array('Inicio', base_url().'app/inicio'), array('Gestión de acuerdos', base_url().'analista/gestion_acuerdos/gestion'), array('Gestión de acuerdos', base_url().'analista/gestion_acuerdos/detalle_acuerdo/'. $idacu), 'Historial de documento');
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo1/usuario/historial_documento_view', $data, TRUE);
