...
/**
 * Description of inscritos_institucion
 *
 * @author UTEQ
 */
class inscritos extends CI_Controller {
    ...
    public function index() {
        ...
        */
        ...
        $data['scripts'] = array();
        $data['scripts'][] = 'observacionInscripcion';
         ...
         */
        $data['breadcrumbs']['titulo'] = "Inscritos";
         ...
         */
        $data['app_fragment'] = $this->load->view('app/private/fragments/modules/Modulo2/usuario/inscrito_usuario_view', $data, TRUE);
